...
#include "PruebasUnreal/BatteryMan.h"
#ifdef _MSC_VER
#pragma warning (push)
...
// Cross Module References
	PRUEBASUNREAL_API UClass* Z_Construct_UClass_ABatteryMan_NoRegister();
	PRUEBASUNREAL_API UClass* Z_Construct_UClass_ABatteryMan();
...
// End Cross Module References
...
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_powerThreshold_MetaData[];
#endif
		static const UE4CodeGen_Private::FFloatPropertyParams NewProp_powerThreshold;
#if WITH_METADATA
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_ABatteryMan_Statics::NewProp_powerThreshold_MetaData[] = {
		{ "Category", "BatteryMan" },
		{ "ModuleRelativePath", "BatteryMan.h" },
	};
#endif
	const UE4CodeGen_Private::FFloatPropertyParams Z_Construct_UClass_ABatteryMan_Statics::NewProp_powerThreshold = { "powerThreshold", nullptr, (EPropertyFlags)0x0010000000000001, UE4CodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(ABatteryMan, powerThreshold), METADATA_PARAMS(Z_Construct_UClass_ABatteryMan_Statics::NewProp_powerThreshold_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_ABatteryMan_Statics::NewProp_powerThreshold_MetaData)) };
#if WITH_METADATA
	...
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_ABatteryMan_Statics::PropPointers[] = {
		...
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_ABatteryMan_Statics::NewProp_powerThreshold,
	...
	IMPLEMENT_CLASS(ABatteryMan, 2235152835);
	template<> PRUEBASUNREAL_API UClass* StaticClass<ABatteryMan>()
	{
		return ABatteryMan::StaticClass();
	}
	static FCompiledInDefer Z_CompiledInDefer_UClass_ABatteryMan(Z_Construct_UClass_ABatteryMan, &ABatteryMan::StaticClass, TEXT("/Script/PruebasUnreal"), TEXT("ABatteryMan"), false, nullptr, nullptr, nullptr);
