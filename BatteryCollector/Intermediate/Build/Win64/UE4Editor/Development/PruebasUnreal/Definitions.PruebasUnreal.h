...
#define UE_PROJECT_NAME PruebasUnreal
#define UE_TARGET_NAME PruebasUnrealEditor
#define UE_MODULE_NAME "PruebasUnreal"
...
#define PRUEBASUNREAL_API DLLEXPORT
